...
{
    /// <summary>Punto di ingresso dell'add-in: crea la scheda "sayRevit" nella barra multifunzione.</summary>
    public class App : IExternalApplication
    {
        ...
        {
            // Revit non cerca le dipendenze nella cartella dell'add-in in tutti i casi: risolviamole noi.
